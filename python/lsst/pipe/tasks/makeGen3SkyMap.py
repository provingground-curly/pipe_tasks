        ...
        if self.config.doWrite:
            try:
                ...
                with self.butler.registry.transaction():
                    ...
                    self.butler.registry.registerDatasetType(DatasetType("SkyMap", ["SkyMap"], "SkyMap"))
                    self.butler.put(skyMap, "SkyMap", {"skymap": self.config.skyMapName})
